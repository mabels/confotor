...
class CheckInManager {
  ...
  //       _appState.bus.add(_lastFoundTicketsStore.reset().toLastFoundTickets());
  //     }
  ...
  //         }
  //       }
  //       _appState.bus.add(_lastFoundTicketsStore.toLastFoundTickets());
  //     }
  ...
  //       _appState.bus.add(_lastFoundTicketsStore
